...
-- Database: robgro_aga_invoices (PRODUCTION)
-- Purpose: Remove seller-related schema changes to fix FK constraint violations
-- =====================================================
--
-- WHAT THIS DOES:
...
SELECT DATABASE() as current_database,
       'Expected: robgro_aga_invoices' as expected_database;
