...
//                    <h4>Hello %s,</h4>
//                    <p>I hope all is well with you!</p>
//                    <p>I wanted to let you know that your invoice (<strong>%s</strong>)<p>
//                    <p>for %s’s cleaning services is attached to this email.<p>
//
//                <p>If there’s anything you’d like to discuss or if you spot anything that needs fixing,<p>
//                <p>don’t hesitate to drop me a message at <a href='mailto:%s'>%s</a>.</p>
